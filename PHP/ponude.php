...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="http://../CSS/style_web-shop.css"-->
...
<div class="w3-container w3-teal">
        <nav class="navigacija">
            <ul class="w3-bar w3-black">
                <a href="http://../html/index.html" class="w3-bar-item w3-button">Pocetna stranica</a></li>
                <a href="http://../ponude.php" class="w3-bar-item w3-button">Sve ponude</a></li>
                <a href="http://../html/registracija.html" class="w3-bar-item w3-button">Registracija</a></li>
            </ul>
        </nav>
    </div>
    <center>
